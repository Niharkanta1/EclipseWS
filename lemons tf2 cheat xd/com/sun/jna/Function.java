...
public class Function extends Pointer
{
    ...
    public Object invoke(final Class returnType, final Object[] inArgs, final Map options) {
        final Method invokingMethod = options.get("invoking-method");
    ...
    Object invoke(final Method invokingMethod, final Class[] paramTypes, final Class returnType, final Object[] inArgs, final Map options) {
        ...
        Object result = this.invoke(args, nativeReturnType, allowObjects);
        if (resultConverter != null) {
