...
public interface User32 extends StdCallLibrary, WinUser, WinNT
{
    ...
    boolean UnregisterClass(final WString p0, final WinDef.HINSTANCE p1);
    
    WinDef.HWND CreateWindowEx(final int p0, final WString p1, final String p2, final int p3, final int p4, final int p5, final int p6, final int p7, final WinDef.HWND p8, final WinDef.HMENU p9, final WinDef.HINSTANCE p10, final WinDef.LPVOID p11);
    
    boolean DestroyWindow(final WinDef.HWND p0);
    
    boolean GetClassInfoEx(final WinDef.HINSTANCE p0, final WString p1, final WNDCLASSEX p2);
    ...
    HMONITOR MonitorFromPoint(final WinDef.POINT p0, final int p1);
    ...
    long SendMessageTimeout(final WinDef.HWND p0, final int p1, final long p2, final long p3, final int p4, final int p5, final WinDef.DWORDByReference p6);
    
    long GetClassLongPtr(final WinDef.HWND p0, final int p1);
