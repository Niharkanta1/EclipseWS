...
public class TypeLib extends Unknown implements ITypeLib
{
    ...
    @Override
    public WinNT.HRESULT FindName(final WTypes.BSTRByReference szNameBuf, final WinDef.ULONG lHashVal, final ITypeInfo[] ppTInfo, final OaIdl.MEMBERID[] rgMemId, final WinDef.USHORTByReference pcFound) {
    ...
    public void ReleaseTLibAttr(final OaIdl.TLIBATTR pTLibAttr) {
        this._invokeNativeObject(12, new Object[] { this.getPointer() }, WinNT.HRESULT.class);
    }
