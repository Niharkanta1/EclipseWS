...
public class DispatchListener extends Structure
{
    ...
    protected void initVTable(final IDispatchCallback callback) {
        ...
        this.vtbl.GetIDsOfNamesCallback = new DispatchVTable.GetIDsOfNamesCallback() {
            @Override
            public WinNT.HRESULT invoke(final Pointer thisPointer, final Guid.GUID.ByValue riid, final WString[] rgszNames, final int cNames, final WinDef.LCID lcid, final OaIdl.DISPIDByReference rgDispId) {
        ...
        this.vtbl.InvokeCallback = new DispatchVTable.InvokeCallback() {
            @Override
            public WinNT.HRESULT invoke(final Pointer thisPointer, final OaIdl.DISPID dispIdMember, final Guid.GUID.ByValue riid, final WinDef.LCID lcid, final WinDef.WORD wFlags, final OleAuto.DISPPARAMS.ByReference pDispParams, final Variant.VARIANT.ByReference pVarResult, final OaIdl.EXCEPINFO.ByReference pExcepInfo, final IntByReference puArgErr) {
