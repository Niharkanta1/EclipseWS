...
public class COMEarlyBindingObject extends COMBindingBaseObject implements IDispatch
{
    ...
    protected String getStringProperty(final OaIdl.DISPID dispId) {
        ...
        this.oleMethod(2, result, this.getIDispatch(), dispId);
        return result.getValue().toString();
    }
    
    protected void setProperty(final OaIdl.DISPID dispId, final boolean value) {
        this.oleMethod(4, null, this.getIDispatch(), dispId, new Variant.VARIANT(value));
    }
    
    @Override
    public WinNT.HRESULT QueryInterface(final Guid.GUID.ByValue riid, final PointerByReference ppvObject) {
