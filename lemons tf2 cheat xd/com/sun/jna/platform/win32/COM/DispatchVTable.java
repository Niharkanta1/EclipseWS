...
public class DispatchVTable extends Structure
{
    ...
    protected List<String> getFieldOrder() {
        return Arrays.asList("QueryInterfaceCallback", "AddRefCallback", "ReleaseCallback", "GetTypeInfoCountCallback", "GetTypeInfoCallback", "GetIDsOfNamesCallback", "InvokeCallback");
    }
    ...
    {
        WinNT.HRESULT invoke(final Pointer p0, final OaIdl.DISPID p1, final Guid.GUID.ByValue p2, final WinDef.LCID p3, final WinDef.WORD p4, final OleAuto.DISPPARAMS.ByReference p5, final Variant.VARIANT.ByReference p6, final OaIdl.EXCEPINFO.ByReference p7, final IntByReference p8);
    }
    
    public interface GetIDsOfNamesCallback extends StdCallLibrary.StdCallCallback
    {
        WinNT.HRESULT invoke(final Pointer p0, final Guid.GUID.ByValue p1, final WString[] p2, final int p3, final WinDef.LCID p4, final OaIdl.DISPIDByReference p5);
    }
