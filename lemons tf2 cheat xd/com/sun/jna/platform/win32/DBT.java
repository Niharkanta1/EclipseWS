...
public interface DBT extends StdCallLibrary
{
    ...
    public static class DEV_BROADCAST_OEM extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dbco_size", "dbco_devicetype", "dbco_reserved", "dbco_identifier", "dbco_suppfunc");
        }
    }
    ...
    public static class DEV_BROADCAST_DEVNODE extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dbcd_size", "dbcd_devicetype", "dbcd_reserved", "dbcd_devnode");
        }
    }
    ...
    public static class DEV_BROADCAST_VOLUME extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dbcv_size", "dbcv_devicetype", "dbcv_reserved", "dbcv_unitmask", "dbcv_flags");
        }
    }
    ...
    public static class DEV_BROADCAST_PORT extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dbcp_size", "dbcp_devicetype", "dbcp_reserved", "dbcp_name");
        }
    }
    ...
    public static class DEV_BROADCAST_NET extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dbcn_size", "dbcn_devicetype", "dbcn_reserved", "dbcn_resource", "dbcn_flags");
        }
    }
    ...
    public static class DEV_BROADCAST_DEVICEINTERFACE extends Structure
    {
        ...
        public DEV_BROADCAST_DEVICEINTERFACE(final Pointer memory) {
            super(memory);
            this.dbcc_name = new char[1];
            this.dbcc_size = (int)this.readField("dbcc_size");
            final int len = 1 + this.dbcc_size - this.size();
    ...
    public static class DEV_BROADCAST_HANDLE extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dbch_size", "dbch_devicetype", "dbch_reserved", "dbch_handle", "dbch_hdevnotify", "dbch_eventguid", "dbch_nameoffset", "dbch_data");
        }
    }
}
