...
public interface WinRas extends StdCallLibrary
{
    ...
    public static class RASEAPINFO extends Structure
    {
        ...
        protected List getFieldOrder() {
            return Arrays.asList("dwSizeofEapInfo", "pbEapInfo");
        }
    ...
    public static class RASDEVSPECIFICINFO extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "pbDevSpecificInfo");
        }
    ...
    public static class RASDIALEXTENSIONS extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "dwfOptions", "hwndParent", "reserved", "reserved1", "RasEapInfo", "fSkipPppAuth", "RasDevSpecificInfo");
        }
    ...
    public static class RASDIALPARAMS extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "szEntryName", "szPhoneNumber", "szCallbackNumber", "szUserName", "szPassword", "szDomain");
        }
    ...
    public static class RASCONN extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "hrasconn", "szEntryName", "szDeviceType", "szDeviceName", "szPhonebook", "dwSubEntry", "guidEntry", "dwFlags", "luid", "guidCorrelationId");
        }
    ...
    public static class RAS_STATS extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "dwBytesXmited", "dwBytesRcved", "dwFramesXmited", "dwFramesRcved", "dwCrcErr", "dwTimeoutErr", "dwAlignmentErr", "dwHardwareOverrunErr", "dwFramingErr", "dwBufferOverrunErr", "dwCompressionRatioIn", "dwCompressionRatioOut", "dwBps", "dwConnectDuration");
        }
    }
    ...
    public static class RASPPPIP extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "dwError", "szIpAddress", "szServerIpAddress", "dwOptions", "dwServerOptions");
        }
    ...
    public static class RASCONNSTATUS extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "rasconnstate", "dwError", "szDeviceType", "szDeviceName", "szPhoneNumber", "localEndPoint", "remoteEndPoint", "rasconnsubstate");
        }
    }
    ...
    public static class RASCREDENTIALS extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("dwSize", "dwMask", "szUserName", "szPassword", "szDomain");
        }
