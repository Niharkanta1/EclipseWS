...
public interface LMAccess extends StdCallLibrary
{
    ...
    public static class LOCALGROUP_INFO_0 extends Structure
    {
        ...
        protected List getFieldOrder() {
            return Arrays.asList("lgrui0_name");
        }
    }
    ...
    public static class LOCALGROUP_INFO_1 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("lgrui1_name", "lgrui1_comment");
        }
    }
    ...
    public static class USER_INFO_0 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("usri0_name");
        }
    }
    ...
    public static class USER_INFO_1 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("usri1_name", "usri1_password", "usri1_password_age", "usri1_priv", "usri1_home_dir", "usri1_comment", "usri1_flags", "usri1_script_path");
        }
    }
    ...
    public static class USER_INFO_23 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("usri23_name", "usri23_full_name", "usri23_comment", "usri23_flags", "usri23_user_sid");
        }
    }
    ...
    public static class GROUP_USERS_INFO_0 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("grui0_name");
        }
    }
    ...
    public static class GROUP_INFO_0 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("grpi0_name");
        }
    }
    ...
    public static class GROUP_INFO_1 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("grpi1_name", "grpi1_comment");
        }
    }
    ...
    public static class GROUP_INFO_2 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("grpi2_name", "grpi2_comment", "grpi2_group_id", "grpi2_attributes");
        }
    }
    ...
    public static class GROUP_INFO_3 extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("grpi3_name", "grpi3_comment", "grpi3_group_sid", "grpi3_attributes");
        }
    }
}
