...
public class XAttrUtil
{
    ...
    public static String getXAttr(final String path, final String name) {
        ...
        return decodeString(valueBuffer.getByteBuffer(0L, valueLength - 1L));
    }
    ...
    protected static Memory encodeString(final String s) {
        ...
        final Memory valueBuffer = new Memory(bb.length + 1);
        valueBuffer.write(0L, bb, 0, bb.length);
        valueBuffer.setByte(valueBuffer.size() - 1L, (byte)0);
        return valueBuffer;
    }
