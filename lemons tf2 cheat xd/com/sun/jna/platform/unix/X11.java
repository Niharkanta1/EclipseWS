...
public interface X11 extends Library
{
    ...
    public interface Xrender extends Library
    {
        ...
        public static class XRenderDirectFormat extends Structure
        {
            ...
            protected List getFieldOrder() {
                return Arrays.asList("red", "redMask", "green", "greenMask", "blue", "blueMask", "alpha", "alphaMask");
            }
        }
        ...
        public static class XRenderPictFormat extends Structure
        {
            ...
            @Override
            protected List getFieldOrder() {
                return Arrays.asList("id", "type", "depth", "direct", "colormap");
            }
        }
    }
    ...
    public static class XInputClassInfoByReference extends Structure implements ByReference
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("input_class", "event_type_base");
        }
    }
    ...
    public static class XDeviceByReference extends Structure implements ByReference
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("device_id", "num_classes", "classes");
        }
    }
    ...
    public static class XWMHints extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("flags", "input", "initial_state", "icon_pixmap", "icon_window", "icon_x", "icon_y", "icon_mask", "window_group");
        }
    }
    ...
    public static class XTextProperty extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("value", "encoding", "format", "nitems");
        }
    }
    ...
    public static class XSizeHints extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("flags", "x", "y", "width", "height", "min_width", "min_height", "max_width", "max_height", "width_inc", "height_inc", "min_aspect", "max_aspect", "base_width", "base_height", "win_gravity");
        }
    ...
    public static class XWindowAttributes extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("x", "y", "width", "height", "border_width", "depth", "visual", "root", "c_class", "bit_gravity", "win_gravity", "backing_store", "backing_planes", "backing_pixel", "save_under", "colormap", "map_installed", "map_state", "all_event_masks", "your_event_mask", "do_not_propagate_mask", "override_redirect", "screen");
        }
    }
    ...
    public static class XSetWindowAttributes extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("background_pixmap", "background_pixel", "border_pixmap", "border_pixel", "bit_gravity", "win_gravity", "backing_store", "backing_planes", "backing_pixel", "save_under", "event_mask", "do_not_propagate_mask", "override_redirect", "colormap", "cursor");
        }
    }
    ...
    public static class XVisualInfo extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("visual", "visualid", "screen", "depth", "c_class", "red_mask", "green_mask", "blue_mask", "colormap_size", "bits_per_rgb");
        }
    }
    ...
    public static class XGCValues extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("function", "plane_mask", "foreground", "background", "line_width", "line_style", "cap_style", "join_style", "fill_style", "fill_rule", "arc_mode", "tile", "stipple", "ts_x_origin", "ts_y_origin", "font", "subwindow_mode", "graphics_exposures", "clip_x_origin", "clip_y_origin", "clip_mask", "dash_offset", "dashes");
        }
    }
    ...
    public static class XAnyEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window");
        }
    }
    ...
    public static class XKeyEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "state", "keycode", "same_screen");
        }
    }
    ...
    public static class XButtonEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "state", "button", "same_screen");
        }
    }
    ...
    public static class XClientMessageEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "message_type", "format", "data");
        }
    ...
    public static class XMotionEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "state", "is_hint", "same_screen");
        }
    }
    ...
    public static class XCrossingEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "root", "subwindow", "time", "x", "y", "x_root", "y_root", "mode", "detail", "same_screen", "focus", "state");
        }
    }
    ...
    public static class XFocusChangeEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "mode", "detail");
        }
    }
    ...
    public static class XExposeEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "x", "y", "width", "height", "count");
        }
    }
    ...
    public static class XGraphicsExposeEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "drawable", "x", "y", "width", "height", "count", "major_code", "minor_code");
        }
    }
    ...
    public static class XNoExposeEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "drawable", "major_code", "minor_code");
        }
    }
    ...
    public static class XVisibilityEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "state");
        }
    }
    ...
    public static class XCreateWindowEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "parent", "window", "x", "y", "width", "height", "border_width", "override_redirect");
        }
    }
    ...
    public static class XDestroyWindowEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "event", "window");
        }
    }
    ...
    public static class XUnmapEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "event", "window", "from_configure");
        }
    }
    ...
    public static class XMapEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "event", "window", "override_redirect");
        }
    }
    ...
    public static class XMapRequestEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "parent", "window");
        }
    }
    ...
    public static class XReparentEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "event", "window", "parent", "x", "y", "override_redirect");
        }
    }
    ...
    public static class XConfigureEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "event", "window", "x", "y", "width", "height", "border_width", "above", "override_redirect");
        }
    }
    ...
    public static class XGravityEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "event", "window", "x", "y");
        }
    }
    ...
    public static class XResizeRequestEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "width", "height");
        }
    }
    ...
    public static class XConfigureRequestEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "parent", "window", "x", "y", "width", "height", "border_width", "above", "detail", "value_mask");
        }
    }
    ...
    public static class XCirculateEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "event", "window", "place");
        }
    }
    ...
    public static class XCirculateRequestEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "parent", "window", "place");
        }
    }
    ...
    public static class XPropertyEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "atom", "time", "state");
        }
    }
    ...
    public static class XSelectionClearEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "selection", "time");
        }
    }
    ...
    public static class XSelectionRequestEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "owner", "requestor", "selection", "target", "property", "time");
        }
    }
    ...
    public static class XSelectionEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "requestor", "selection", "target", "property", "time");
        }
    }
    ...
    public static class XColormapEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "colormap", "c_new", "state");
        }
    }
    ...
    public static class XMappingEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "request", "first_keycode", "count");
        }
    }
    ...
    public static class XKeymapEvent extends Structure
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("type", "serial", "send_event", "display", "window", "key_vector");
        }
    }
    ...
    public static class XModifierKeymapRef extends Structure implements ByReference
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("max_keypermod", "modifiermap");
        }
    }
    ...
    public static class XKeyboardStateRef extends Structure implements ByReference
    {
        ...
        @Override
        protected List getFieldOrder() {
            return Arrays.asList("key_click_percent", "bell_percent", "bell_pitch", "bell_duration", "led_mask", "global_auto_repeat", "auto_repeats");
        }
