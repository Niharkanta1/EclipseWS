...
public class NativeLibrary
{
    ...
    private NativeLibrary(final String libraryName, final String libraryPath, final long handle, final Map options) {
        ...
        this.encoding = options.get("string-encoding");
    ...
    private static NativeLibrary loadLibrary(final String libraryName, final Map options) {
        ...
        try {
            ...
            if (handle == 0L) {
                try {
                    final File embedded = Native.extractFromResourcePath(libraryName, options.get("classloader"));
                    try {
    ...
    Function getFunction(String name, final Method method) {
        final FunctionMapper mapper = this.options.get("function-mapper");
        if (mapper != null) {
